...
{
  "md", "steep", "cg", "gsa", "bd", "sd", "nm", "l-bfgs", "tpi", "tpic", "sd1", "mc", NULL 
};
...
const char *etcoupl_names[etcNR+1] = {
  "No", "Berendsen", "Nose-Hoover", "yes", "Andersen", "Andersen-interval", "V-rescale", "MC", NULL
}; /* yes is alias for berendsen */

const char *epcoupl_names[epcNR+1] = {
  "No", "Berendsen", "Parrinello-Rahman", "Isotropic", "MC", NULL
